...
export default async function AdminHomePage() {
  ...
  const [activityRows, sellerRows, pendingSales, expenseCategories] = await Promise.all([
  ...
  return (
    <>
      ...
      <QuickActions activities={activityRows} categories={expenseCategories} />
