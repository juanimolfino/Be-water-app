...
function activityValues(input: ActivityDetails) {
  return {
    ...
    tieredCommission: input.tieredCommission || null,
...
export async function setAgendaDayFull(input: { diveCenterId: string; flagDate: string; createdByUserId: string }) {
...
export async function unsetAgendaDayFull(input: { diveCenterId: string; flagDate: string }) {
  return getDb()
